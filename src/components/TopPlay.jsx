...
// as we need to scroll up every time we dont set the dependency array to empty
...
const TopPlay = ({ song, i }) => {
  ...
  return (
    <div
      ref={divRef}
      className="xl:ml-6 ml-0 zl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col"
    >
      <div className="w-full flex flex-col">
        ...
        <div className=" text-white mt-4 flex-col gap-1">
          {topPlays?.map((song, i) => (
